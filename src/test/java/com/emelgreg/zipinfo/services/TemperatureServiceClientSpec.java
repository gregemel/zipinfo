...
import com.emelgreg.zipinfo.adapters.TemperatureServiceClientImpl;
...
public class TemperatureServiceClientSpec {
    ...
    @Mock
    OpenWeatherResponseHandler parser;

    @InjectMocks
    TemperatureServiceClientImpl target;
